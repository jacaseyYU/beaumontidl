;+
; PURPOSE:
;  This procedure calculates the parameters (i.e. covariance matrix,
;  mean, normalization factor) of the multivariate gaussian
;  obtained by multiplying two other multivariate gaussians
;  together. The two input gaussians are assumed to be normalized.
;
; CATEGORY:
;  statistics
;
...
;  norm: The normalization factor (the constant outside the
;        exponential).
;
; MODIFICATION HISTORY:
;  November 2009: Written by Chris Beaumont
;-
pro gauss_prod, mu1, mu2, covar1, covar2, mu, covar, norm
  compile_opt idl2
  
  ;- check inputs
  if n_params() ne 7 then begin
     print, 'calling sequence'
     print, '  gauss_prod, mu1, mu2, covar1, covar2, mu, covar, norm'
     return
  endif
