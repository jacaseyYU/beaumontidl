;+
; PURPOSE:
;  Search a line of IDL source code for calls to other procedures,
...
;     subscripts will be mistaken for function calls.
;  1) Does not consider object method calls (i.e. stack->push)
;  2) Does not search inside quotations, and thus cannot find
;     dependencies inside calls to execute, call_function, call_pro,
;     etc. E.g., if linein is " result = execute('function(5)')", 
;     this function will not find the all to function
;
